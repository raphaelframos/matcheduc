 ...
 * Use the [ThemeInformationFragment.newInstance] factory method to
...
class ThemeInformationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ThemeInformationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ThemeInformationFragment().apply {
